(function() {
  ...
  var COUNTRY_ALIASES = S.COUNTRY_ALIASES;
  var sharedNormalizeCountry = S.normalizeCountry;
  ...
  // Normalize country name to canonical form — delegates to @irc/shared
  window.IRC.normalizeCountry = function(raw) {
    if (!raw) return '';
    return sharedNormalizeCountry(raw.toString()) || '';
  };
